...
The plot demonstrates the extra part — the goal-difference share
$|T_A-T_B|/(10G)$ that $x$ scales — for 2- and 3-game matches in which
team $A$ wins every game:

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="weight_function_dark.png">
  <img alt="Goal-difference share vs opponent goal total for 2- and 3-game sweeps: both lines fall linearly from 1 at a shutout to 0 as the opponent catches up"
       src="weight_function_light.png">
</picture>

*(Generated by matplotlib. The 3-game line is partly theoretical — a
real best-of-three winner playing 3 games concedes one, so
$T_A \le 29$ and $T_B \ge 10$.)*
